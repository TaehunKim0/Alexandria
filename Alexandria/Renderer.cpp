...
bool Renderer::Init()
{
	...
	pp.hDeviceWindow = Application::GetInstance()->GetHandle();

	if (FAILED(m_D3D->CreateDevice(D3DADAPTER_DEFAULT, D3DDEVTYPE_HAL, pp.hDeviceWindow, D3DCREATE_SOFTWARE_VERTEXPROCESSING, &pp, &m_D3DDevice)))
	{
